 ...
 * @property \App\Model\Table\AuthorizationsTable&\Cake\ORM\Association\BelongsToMany $Authorizations
 *
...
class RolesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsToMany('Authorizations', [
            'foreignKey' => 'role_id',
            'targetForeignKey' => 'authorization_id',
            'joinTable' => 'authorizations_roles',
        ]);
    }
