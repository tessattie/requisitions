...
<div class="container-fluid"> 
    <div class="panel panel-default articles">
        <div class="panel-heading">
            <?= __("Editer l'Utilisateur") ?> : <?= $user->name ?>
    ...
    <div class="panel-body articles-container">       
            <?= $this->Form->create($user) ?>
                ...
                <div class="col-md-4"><?= $this->Form->control('status', array('class' => 'form-control', "options" => $status, 'style' => "height:46px", "label" => __("Statut")." *")); ?></div>
